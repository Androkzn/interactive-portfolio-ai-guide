/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/guide-api/wrangler.jsonc apps/guide-api/worker-configuration.d.ts` (hash: 3bf7209f54df3e2f7c8391e81dd83e23)
// Runtime types generated with workerd@1.20260915.1 2026-09-15 
interface __BaseEnv_Env {
	ENVIRONMENT: "staging" | "production" | "development";
	AI?: Ai;
	ALLOWED_ORIGINS?: "http://localhost:3000,https://interactive-portfolio-ai-guide.pages.dev";
	GENERATIVE_GUIDE_ENABLED?: "false";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "GENERATIVE_GUIDE_ENABLED">> {}
}

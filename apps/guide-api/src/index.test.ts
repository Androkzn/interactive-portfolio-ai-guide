...
const validBody = { protocol: GUIDE_PROTOCOL, sessionId: "session-12345678", projectId: "symply-house", mode: "interview", language: "en", viewport: "desktop", question: "What was the hardest part?", history: [] };
...
describe("guide API", () => {
  it("returns a grounded curated answer with sources", async () => {
    ...
    expect(body.sourceIds).toContain("symply-house.platform-matrix");
    expect(body.answer).toContain("iPhone");
  });

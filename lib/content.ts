...
export const projects: Project[] = [
  {
    ...
    runtimeLabel: "Connected Expo Web build · production API · sign-in required",
    ...
    challenge: { title: "Keep a shared home calm and useful", body: "The live Web build uses the production Symply House API. Authentication is required before household data is read; the portfolio does not embed credentials or a shared account." },
    evidence: [
      ...
      { label: "Live boundary", type: "runtime", detail: "Production API with app authentication; no credentials are embedded in the portfolio." },
    ],
  },
  {
    id: "hoc-v2",
  ...
  },
  {
    ...
    challenge: { title: "Design for trust when data is personal", body: "The live Web build uses the production Symply Budget API and keeps its normal authentication gate. The portfolio provides no shared financial account and never places credentials in client code." },
    evidence: [
      ...
      { label: "Live boundary", type: "runtime", detail: "Production API with user authentication; banking, payment and identity credentials remain outside the portfolio." },
    ],
  },
];

...
export const projects: Project[] = [
  {
    ...
    evidence: [
      { label: "Source repository", type: "verified", detail: "Private source project — the repository is not publicly browsable, so nothing here links to it." },
    ...
    screenInsights: [
      ...
      },
      {
        ...
        challenge: { title: "Translate a spatial model into a cross-platform surface", body: "A floor plan needs viewing, zone context and marker placement without assuming the interaction affordances of only one native platform." },
  ...
  },
  {
    ...
    number: "02",
    name: "Symply Health",
    eyebrow: "Source project · privacy-first health tracking",
    summary: "A privacy-first health tracker for iPhone, iPad, Android and Apple Watch, built on a read-only HealthKit import and an outbox that stops offline edits being overwritten.",
    ...
    evidence: [
      { label: "Source repository", type: "verified", detail: "Private source project — the code is not publicly browsable, so nothing here links to it." },
